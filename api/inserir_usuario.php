<?php
	...
	if(move_uploaded_file($imagem['tmp_name'], $caminho_upload)) {
		$query  = "insert into usuario(nome, cpf, data_nascimento, tipo_usuario_id, documento_id, foto, telefone, email, ultima_atualizacao) ";
		$query .= "values('".$nome."', '".$cpf."', '".$dt_nascimento."', ".$tipo_usuario.", ".$documento.", '".$caminho_banco."', '".$tel."', '".$email."', now());";
