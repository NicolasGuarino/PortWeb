	...
	<body>
		<div id="principal">
			<div class="container" id="login_container">
				...
				<span class="container_tit"> Login </span>
				...
				<form name="frm_login" method="post">
					...
					<label class="lbl_container"> Senha </label>
			...
			<div class="container" id="enviar_email_container">
				<div class="container_logo"></div>
				<span class="container_tit"> Recuperar senha </span>
			...
			<div class="container" id="recuperar_senha_container">
				...
				<label class="lbl_container"> Nova senha </label>
				<input type="password" name="txt_senha" placeholder="nova senha" class="form_txt" id="nova_senha" />

				<label class="lbl_container"> Confirmar senha </label>
